 ...
 * @var string
 */
define('SECRET_ACCESS_TOKEN', 'jhsjaasljswklejqjeqlwjelqjewqjdsnsadksjahdjhsahdsasajdsSAJKHDJKSHA');
 ...
 * @var string
 */
define('REMOTE_REPOSITORY', 'git@github.com:status-im/cn.status.im.git');
